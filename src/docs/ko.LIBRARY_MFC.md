...
![그림 1. MFC 구조 설명을 위한 예시.](../images/docs/mfc/mfc_architecture_example.png)
...
![그림 2. 메모장의 뷰(view) 구조물.](../images/docs/mfc/mfc_architecture_view.png)
...
![그림 3. 메모장의 프레임 창(frame window) 구조물.](../images/docs/mfc/mfc_architecture_framewnd.png)
...
![그림 4. 메모장의 어플리케이션(frame window) 구조물.](../images/docs/mfc/mfc_architecture_application.png)
...
![그림 5. 비주얼 스튜디오 메뉴 리소스.](../images/docs/mfc/mfc_resource_menu.png)

메뉴는 각 프레임 창마다 하나만 가질 수 있는 특징이 있으며, 주로 프로그램 옵션 및 설정에 자주 사용된다. 메모장 프로그램에도 메뉴 리소스가 존재하는 것을 확인할 수 있다.

한편, 비주얼 스튜디오에서 툴바는 아래와 같다.

![그림 6. 비주얼 스튜디오 툴바 리소스.](../images/docs/mfc/mfc_resource_toolbar.png)
...
![그림 7. 비주얼 스튜디오 다이얼로그 리소스.](../images/docs/mfc/mfc_resource_dialog.png)
...
![그림 9. 비주얼 스튜디오 시작화면.](../images/docs/mfc/mfc_vs_project1.png)
