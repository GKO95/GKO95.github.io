...
![그림 3. 비주얼 스튜디오 C++ 프로그래밍을 위한 구성요소.](/images/docs/cpp/cpp_vs_component.png)
...
![그림 4. 비주얼 스튜디오 시작화면.](/images/docs/cpp/cpp_vs_project1.png)
...
![그림 5. 비주얼 스튜디오 C++ 프로젝트 생성 (1단계).](/images/docs/cpp/cpp_vs_project2.png)
...
![그림 6. 비주얼 스튜디오 C++ 프로젝트 생성 (2단계).](/images/docs/cpp/cpp_vs_project3.png)

3. 비주얼 스튜디오에서 알아서 준비한 프로젝트를 그대로 사용한다.

![그림 7. 비주얼 스튜디오 C++ 프로젝트 생성 (3단계).](/images/docs/cpp/cpp_vs_project4.png)
...
![그림 8. 엑스코드 시작화면.](/images/docs/cpp/cpp_xcode_project1.png)
...
![그림 9. 엑스코드 C++ 프로젝트 생성 (1단계).](/images/docs/cpp/cpp_xcode_project2.png)
