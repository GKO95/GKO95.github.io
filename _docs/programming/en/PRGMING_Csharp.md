...
![Figure 1. .NET Common Language Infrastructure (CLI)<sub><i>Ref: <a href="https://commons.wikimedia.org/wiki/File:Overview_of_the_Common_Language_Infrastructure.svg">Wikipedia</a></i></sub>](/assets/img/docs/programming/Csharp/csharp_wiki_netframework.png)
...
![Figure 2. Workload for C# programming on Visual Studio.](/assets/img/docs/programming/Csharp/csharp_vs_component.png)
...
![Figure 3. Startup window of Visual Studio.](/assets/img/docs/programming/Csharp/csharp_vs_project1.png)
...
![Figure 4. Creating a C# project on Visual Studio (step 1).](/assets/img/docs/programming/Csharp/csharp_vs_project2.png)
...
![Figure 5. Creating a C# project on Visual Studio (step 2).](/assets/img/docs/programming/Csharp/csharp_vs_project3.png)

3. Use the project automatically prepared by Visual Studio.

![Figure 6. Creating a C# project on Visual Studio (step 3).](/assets/img/docs/programming/Csharp/csharp_vs_project4.png)
