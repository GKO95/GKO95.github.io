...
title: "Programming | C"
logo: "/assets/img/res/logo-c.png"
order: 0x01
---
# **C: INTRO**
...
![Figure 1. Workload for C programming on Visual Studio.](/assets/img/docs/programming/C/c_vs_component.png)
...
![Figure 2. Startup window of Visual Studio.](/assets/img/docs/programming/C/c_vs_project1.png)
...
![Figure 3. Creating a C project on Visual Studio (step 1).](/assets/img/docs/programming/C/c_vs_project2.png)
...
![Figure 4. Creating a C project on Visual Studio (step 2).](/assets/img/docs/programming/C/c_vs_project3.png)

3. On the Solution Explorer, right-click the Source Files filter and select the `Add > New Items...` option.

![Figure 5. Creating a C project on Visual Studio (step 3).](/assets/img/docs/programming/C/c_vs_project4.png)

4. On the Add New Item window, change the extension from `.cpp` to `.c`, which is a source code extension for C language.

![Figure 6. Creating a C project on Visual Studio (step 4).](/assets/img/docs/programming/C/c_vs_project5.png)
...
![Figure 7. Startup window of Xcode.](/assets/img/docs/programming/C/c_xcode_project1.png)
...
![Figure 8. Creating a C project on Xcode (step 1).](/assets/img/docs/programming/C/c_xcode_project2.png)

2. Name a project in the Product Name and select the Language as C.

![Figure 9. Creating a C project on Xcode (step 2).](/assets/img/docs/programming/C/c_xcode_project3.png)

3. Designate a path for the project.

![Figure 10. Creating a C project on Xcode (steo 3).](/assets/img/docs/programming/C/c_xcode_project4.png)
...
![Figure 11. Creating a C project on Xcode (step 4).](/assets/img/docs/programming/C/c_xcode_project5.png)
...
![Figure 12. Example code for GCC compiler.](/assets/img/docs/programming/C/c_gcc_project1.png)

Suppose the `main.c` source file is at `~/Workspace/C/Experiment` directory.

![Figure 13. Creating C language program using GCC compiler (step 1).](/assets/img/docs/programming/C/c_gcc_project2.png)
...
![Figure 14. Creating C language program using GCC compiler (step 2).](/assets/img/docs/programming/C/c_gcc_project3.png)
...
![Figure 15. Creating C language program using GCC compiler (step 3).](/assets/img/docs/programming/C/c_gcc_project4.png)

To execute an object file from a terminal, place `./` followed by the file name.

![Figure 16. Creating C language program using GCC compiler (step 4).](/assets/img/docs/programming/C/c_gcc_project5.png)
