...
![그림 1. 비주얼 스튜디오 C 프로그래밍을 위한 구성요소.](/assets/img/docs/programming/C/c_vs_component.png)
...
![그림 2. 비주얼 스튜디오 시작화면.](/assets/img/docs/programming/C/c_vs_project1.png)
...
![그림 3. 비주얼 스튜디오 C 프로젝트 생성 (1단계).](/assets/img/docs/programming/C/c_vs_project2.png)
...
![그림 4. 비주얼 스튜디오 C 프로젝트 생성 (2단계).](/assets/img/docs/programming/C/c_vs_project3.png)

3. 오른쪽의 솔루션 탐색기(Solution Explorer)에서 소스 파일(Source Files)에 오른쪽 클릭하여 `추가 > 새 항목`을 클릭한다.

![그림 5. 비주얼 스튜디오 C 프로젝트 생성 (3단계).](/assets/img/docs/programming/C/c_vs_project4.png)

4. 새 항목 추가 창에서 C++ 파일을 선택하나, 파일 이름에서 확장자를 C++ 소스 파일 확장자의 `.cpp`에서 C 소스 파일 확장자인 `.c`로 변경한다.

![그림 6. 비주얼 스튜디오 C 프로젝트 생성 (4단계).](/assets/img/docs/programming/C/c_vs_project5.png)
...
![그림 7. 엑스코드 시작화면.](/assets/img/docs/programming/C/c_xcode_project1.png)
...
![그림 8. 엑스코드 C 프로젝트 생성 (1단계).](/assets/img/docs/programming/C/c_xcode_project2.png)

2. Product Name에는 프로젝트 이름을 선정하고, Language에는 C로 선택한다.

![그림 9. 엑스코드 C 프로젝트 생성 (2단계).](/assets/img/docs/programming/C/c_xcode_project3.png)

3. 프로젝트를 저장할 경로를 고른다.

![그림 10. 엑스코드 C 프로젝트 생성 (3단계).](/assets/img/docs/programming/C/c_xcode_project4.png)

4. 왼쪽 패널에는 Experiment 폴더 아래에 `main.c`라는 C 소스 파일이 생성되어 있으며, 최소한의 기본 코드가 작성되어 있다.

![그림 11. 엑스코드 C 프로젝트 생성 (4단계).](/assets/img/docs/programming/C/c_xcode_project5.png)
...
![그림 12. gcc 컴파일 작업 예시 코드.](/assets/img/docs/programming/C/c_gcc_project1.png)

위의 `main.c` 소스 파일은 `~/Workspace/C/Experiment` 경로에 저장되었다고 하자.

![그림 13. gcc 컴파일러의 C 언어 프로그램 생성 (1단계).](/assets/img/docs/programming/C/c_gcc_project2.png)

터미널을 실행하여 소스 파일이 위치한 경로로 이동한다. 터미널에서 경로 이동은 `cd` 명령어를 사용한다. 소스 파일을 컴파일하기 위해서는 아래의 명령어를 입력한다.

![그림 14. gcc 컴파일러의 C 언어 프로그램 생성 (2단계).](/assets/img/docs/programming/C/c_gcc_project3.png)
...
![그림 15. gcc 컴파일러의 C 언어 프로그램 생성 (3단계).](/assets/img/docs/programming/C/c_gcc_project4.png)

이진 파일 `main`을 실행하기 위해서는 터미널에서 `./`와 함께 실행 파일 이름을 입력한다.

![그림 16. gcc 컴파일러의 C 언어 프로그램 생성 (4단계).](/assets/img/docs/programming/C/c_gcc_project5.png)
