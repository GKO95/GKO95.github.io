...
![그림 1. 비주얼 스튜디오 C++ 프로그래밍을 위한 구성요소.](/assets/images/docs/programming/Cpp/cpp_vs_component.png)
...
![그림 2. 비주얼 스튜디오 시작화면.](/assets/images/docs/programming/Cpp/cpp_vs_project1.png)
...
![그림 3. 비주얼 스튜디오 C++ 프로젝트 생성 (1단계).](/assets/images/docs/programming/Cpp/cpp_vs_project2.png)
...
![그림 4. 비주얼 스튜디오 C++ 프로젝트 생성 (2단계).](/assets/images/docs/programming/Cpp/cpp_vs_project3.png)

3. 비주얼 스튜디오에서 알아서 준비한 프로젝트를 그대로 사용한다.

![그림 5. 비주얼 스튜디오 C++ 프로젝트 생성 (3단계).](/assets/images/docs/programming/Cpp/cpp_vs_project4.png)
...
![그림 6. 엑스코드 시작화면.](/assets/images/docs/programming/Cpp/cpp_xcode_project1.png)
...
![그림 7. 엑스코드 C++ 프로젝트 생성 (1단계).](/assets/images/docs/programming/Cpp/cpp_xcode_project2.png)

2. Product Name에는 프로젝트 이름을 선정하고, Language에는 C++로 선택한다.

![그림 8. 엑스코드 C++ 프로젝트 생성 (2단계).](/assets/images/docs/programming/Cpp/cpp_xcode_project3.png)

3. 프로젝트를 저장할 경로를 고른다.

![그림 9. 엑스코드 C++ 프로젝트 생성 (3단계).](/assets/images/docs/programming/Cpp/cpp_xcode_project4.png)

4. 왼쪽 패널에는 Experiment 폴더 아래에 `main.cpp`라는 C++ 소스 파일이 생성되어 있으며, 최소한의 기본 코드가 작성되어 있다.

![그림 10. 엑스코드 C++ 프로젝트 생성 (4단계).](/assets/images/docs/programming/Cpp/cpp_xcode_project5.png)
...
![그림 11. g++ 컴파일 작업 예시 코드.](/assets/images/docs/programming/Cpp/cpp_g++_project1.png)

위의 `main.cpp` 소스 파일은 `~/Workspace/Cpp/Experiment` 경로에 저장되었다고 하자.

![그림 12. g++ 컴파일러의 C++ 언어 프로그램 생성 (1단계).](/assets/images/docs/programming/Cpp/cpp_g++_project2.png)

터미널을 실행하여 소스 파일이 위치한 경로로 이동한다. 터미널에서 경로 이동은 `cd` 명령어를 사용한다. 소스 파일을 컴파일하기 위해서는 아래의 명령어를 입력한다.

![그림 13. g++ 컴파일러의 C++ 언어 프로그램 생성 (2단계).](/assets/images/docs/programming/Cpp/cpp_g++_project3.png)
...
![그림 14. g++ 컴파일러의 C++ 언어 프로그램 생성 (3단계).](/assets/images/docs/programming/Cpp/cpp_g++_project4.png)

이진 파일 `main`을 실행하기 위해서는 터미널에서 `./`와 함께 실행 파일 이름을 입력한다.

![그림 15. g++ 컴파일러의 C++ 언어 프로그램 생성 (4단계).](/assets/images/docs/programming/Cpp/cpp_g++_project5.png)
...
![그림 16. 비주얼 스튜디오에서 클래스 파일 생성하기.](/assets/images/docs/programming/Cpp/cpp_vs_class.png)
