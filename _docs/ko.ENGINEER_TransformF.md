...
\displaystyle \lvert c_k \rvert & \displaystyle = \sqrt{\left( \mathrm{Re}\left\{c_{k} \right\} \right)^2 + \left( \mathrm{Im}\left\{c_{k} \right\} \right)^2} & \displaystyle = \frac{1}{2}\sqrt{a_k^2 + b_k^2}
